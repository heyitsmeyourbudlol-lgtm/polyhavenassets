...
## Current snapshot (2026-09-09 07:09 UTC)

| Metric | Value |
|--------|------:|
| Newdrop merges (7d) | 20 |
| Non-noop cycles/day | 13 today · proj 43.6/day · week_avg 11.0 (bar ≥8) [PASS] |
| Free-desktop agent cap | 8 |
| Theater Active share | 0% (0/2 open) |
| Brain / daemons | CLEAN peer-loop=active improve-loop=active ssh_rc=0 |

Merges: #327 GitHub App install capability-URL noindex (after #325) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/327); #325 Agent distribution static nosniff + Content-Language (after  (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/325); #324 Auth signout capability-URL noindex (after #323) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/324); #323 Crawl-brief discovery Link self+alternate (after #321) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/323); #321 Public widget OPTIONS Access-Control-Max-Age (after #320) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/321)
